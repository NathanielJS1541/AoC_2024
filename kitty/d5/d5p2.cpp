                    ...
                    for (int i = 1; i < output.size(); i++)
                    {
                            ...
                            for (int k = 0; k < instructionSet->size(); k++)
                            {
                                ...
                                for (int j = i - 1; j >= 0; j--)
                                {
                                    ...
                                    if (output[j] == instructionSet->at(k))
                                    {
                                        ...
                                        // swap the two entries the rule relates to and go again.
                                        iter_swap(output.begin()+j, output.begin()+i);
                        ...
                        if (i == output.size() - 1)
                        {
                            if (bad)
                            {
                                ...
                                cout << "The new middle number is: " << output[output.size() / 2] << endl;
                                cout << "The above was a success\n"
                                     << endl;
                            }
                            // if there was no bad entry in this line then move on
                            else
                            {
                                cout<< "Skipped this one" <<endl;
                            }
                            cont = false;
                        }
                    }
